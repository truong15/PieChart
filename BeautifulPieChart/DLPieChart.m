...
- (void)renderInLayer:(DLPieChart *)layerHostingView dataArray:(NSMutableArray*)dataArray
{
    ...
    UIColor *greenColor = [[UIColor greenColor] colorWithAlphaComponent:0.8];
    UIColor *pinkColor = [[UIColor purpleColor] colorWithAlphaComponent:0.8];
    UIColor *redColor = [[UIColor redColor] colorWithAlphaComponent:0.8];
    self.DLColorsArray = [@[greenColor,pinkColor,redColor] mutableCopy];
...
{
     SliceLayer *selectedLayer = [_pieView.layer.sublayers objectAtIndex:index];
    for (SliceLayer *layer in _pieView.layer.sublayers) {
